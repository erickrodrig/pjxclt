// import { calculateCompPJ } from "../../src/core/calculateCompensationPJ";

// describe('calculateCompPJ', () => {
...
//       expect(() => {
//         calculateCompPJ({ ...defaultValues, ...input })
...
//       const result = calculateCompPJ(input);
